...
uses
  ...
  System.Actions, Vcl.ActnList, Vcl.StdActns, clipbrd, JSON, System.RegularExpressions;
...
var HTTP: TIdHTTP;
    ...
    XMLLink, DOCLink, PDFLink, shortName, longName, period, srok, Okud, DateYtv: String;
  ...
  try
    ...
    while TryStrToInt(nextPage, temp) do begin
      ...
      for var i := 0 to formsCounter-1 do begin
        longName := ''; XMLLink := ''; DOCLink := ''; PDFLink := ''; shortName := ''; Okud := ''; DateYtv := '';
        longNamePos := 0;
        XMLPos := 0;
        DOCPos := 0;
        PDFPos := 0;
